...
<div class="container">
    ...
    <a href="{{ route('tabelakuntansimaster.create') }}" class="btn btn-primary mb-3">Tambah Data</a>
    ...
    <table class="table table-bordered table-striped table-primary">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="{{ route('tabelakuntansimaster.edit', $item->id_perkiraan) }}" class="btn btn-warning btn-sm">Edit</a>
                    <form action="{{ route('tabelakuntansimaster.destroy', $item->id_perkiraan) }}" method="POST" style="display:inline;">
                        @csrf
                        @method('DELETE')
